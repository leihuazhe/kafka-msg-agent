...
nohup java -server $JVM_OPTS $SOA_BASE $DEBUG_OPTS $USER_OPTS  $E_JAVA_OPTS -jar $PRGDIR/kafka-msg-agent-jar-with-dependencies.jar >> $LOGDIR/console.log 2>&1 &
